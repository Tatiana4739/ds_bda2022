// ORM class for table 'attendance'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat May 07 23:21:31 MSK 2022
...
public class attendance extends SqoopRecord  implements DBWritable, Writable {
  ...
  public attendance with_university(String university) {
    this.university = university;
    return this;
  }
  private String id;
  ...
  public attendance with_id(String id) {
    this.id = id;
    return this;
  }
  ...
  public attendance with_timestamp(String timestamp) {
    this.timestamp = timestamp;
    return this;
  }
  ...
  public attendance with_event_type(String event_type) {
    this.event_type = event_type;
    return this;
  }
  private String year;
  ...
  public attendance with_year(String year) {
    this.year = year;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.event_type = JdbcWritableBridge.readString(4, __dbResults);
    this.year = JdbcWritableBridge.readString(5, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(timestamp, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(event_type, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(year, 5 + __off, 12, __dbStmt);
    return 5;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    attendance o = (attendance) super.clone();
    return o;
  }

  public void clone0(attendance o) throws CloneNotSupportedException {
  }
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("event_type".equals(__fieldName)) {
      this.event_type = (String) __fieldVal;
    }
